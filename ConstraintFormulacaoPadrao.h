 ...
 */
class ConstraintFormulacaoPadraoHasher : public stdext::hash_compare<ConstraintFormulacaoPadrao>
{
public:
	/**
	 ...
	 */
	bool operator() (const ConstraintFormulacaoPadrao& cons1, const ConstraintFormulacaoPadrao& cons2) const;
};

/**
 * Type definition for the hash object.
 */
typedef stdext::hash_map<ConstraintFormulacaoPadrao, int, ConstraintFormulacaoPadraoHasher> ConstraintFormulacaoPadraoHash;